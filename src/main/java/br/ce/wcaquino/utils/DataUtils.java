...
public class DataUtils {
	...
	public static Date obterDataComDiferencaDias(Date dataReferencia, int dias) {
		return adicionarDias(dataReferencia, dias);
	}
	...
	public static int compararData(Date dataReferencia, Date dataB) {
		if(isMesmaData(dataReferencia, dataB)) return 0;
		Calendar calendarReferencia = Calendar.getInstance();
		calendarReferencia.setTime(dataReferencia);
